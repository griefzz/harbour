...
<center>A Web Server Framework For Modern C++ </center>
...
**Harbour** is a web server framework that cares about the developer.  

The core principles of **Harbour**:

- Make the obvious way the right way.
- Always use good defaults
- Keep things simple

This stays true for the vast majority of the code base.

## Getting Started

This will go over the basic concepts of harbour and how to create something meaningful with its api.
After going through this you should have everything you need to start building!

## Running A Server

After linking harbour as described in [Integration](https://griefzz.github.io/integration/cmake/) you can create a main.cpp file
...
By default harbour will open on port 8080. This can be changed with a server settings object.
...
Head over to [Features](https://griefzz.github.io/features/) to get an overview of what Harbour has to offer!
